...
There many details to this system that are necessary for it to work.
The power supply must take 110 volts AC from a residential outlet
and convert it to 24 volts AC for the sprinkler valves and 5 volts
DC for the Linux computer and the digital logic.
...
The web based user interface must allow the timer schedule to be
...
Additional Control Drivers can added to expand the system for more
valves.  Each Control Driver supports up to eight valves.
